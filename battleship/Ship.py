...
class Ship:
    ...
    def __init__(self, length, front, back):
        ...
        Actions:
            ...
            init also creates arrays:
                self.is_hit_array- a bool array the length of the ship holding if the ship   "has been hit" or not
    ...
    def hit(self, location):
        ...
        Action:
            ...
            location saved in the board_array. It will then check the is_hit array of the corresponding "i"
